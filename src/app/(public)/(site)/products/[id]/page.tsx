...
import ProductCarousel from '@/app/(public)/(site)/products/[id]/product-carousel';
import ProductMedia from '@/app/(public)/(site)/products/[id]/product-media';
import ProductReviewCard from '@/app/(public)/(site)/products/[id]/product-review-card';
import ProductReviewStats from '@/app/(public)/(site)/products/[id]/product-review-stats';
import ProductCard from '@/app/(public)/(site)/products/product-card';
...
export default async function ProductDetails(props: { params: Params }) {
  ...
  return (
    <main>
      <section className="p-6 md:px-16 md:py-12 !pb-0">
